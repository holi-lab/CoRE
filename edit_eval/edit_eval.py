...
from easyeditor import (
    ...
    EMMETHyperParams, FTHyperParams, COREHyperParams, BaseEditor
)
...
def calculate_metrics(
    ...
    # LOCALITY success
    loc_succ = float(avg_metrics.get("LOCALITY", {}).get("editing_success", 0.0))
    loc_metrics = {"LOCALITY/editing_success": loc_succ} if loc_succ else {}
...
def main():
    ...
    sent_succ, rep_m, loc_m = calculate_metrics(avg_m)
